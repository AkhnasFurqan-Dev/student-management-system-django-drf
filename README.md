...
> **A Student Management REST API designed around strict role-based access control, secure JWT authentication, automated academic notifications, PostgreSQL persistence, and Test-Driven Development.**
